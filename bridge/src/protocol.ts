...
// because this bridge, the relay, and the Vite app are independently
// deployable units — see docs/plans/2026-08-08-pzmap-live-3-server-bridge.md,
// Global Constraints. Keep the `v` field and shape in sync by hand.
